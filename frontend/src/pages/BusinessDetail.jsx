...
const CATEGORIES = [
  ...
  'Daily Needs','Doctors','Jobs','Jewellery','Labs & Diagnostics',
  'Banking & Finance','Packers & Movers','Wedding Services','Hotels & Restaurants','Repairs',
  'IT & Software','Construction Materials','Pest Control','Agriculture','Printing Services',
  'Textiles & Garments','Travel & Tourism','Home Appliances','Demand Services','Religious',
  'Organic Products','Advertising','Insurance','Advocate & Legal','Courier Services',
];
            ...
            <div className="p-5 space-y-4">
              ...
              {EXTRA_FIELDS.map((f) => {
                ...
                if (f.type === 'coverimage') {
                  ...
                  return (
                    <div key={f.name}>
                      <label className="label">{f.label} <span className="text-gray-400 font-normal normal-case text-xs">(banner ratio 4:1)</span></label>
                      ...
                      <input type="file" accept="image/*" className="input"
                        onChange={(e) => { const file = e.target.files?.[0]; if (file) openCrop(file, 4, 'cover'); e.target.value = ''; }} />
                    </div>
                  );
                }
