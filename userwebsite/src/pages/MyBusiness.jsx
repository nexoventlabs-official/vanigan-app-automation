...
import {
  Phone, RefreshCw, Store, Trash2, ExternalLink, MessageCircle,
    ...
    <div>
      ...
      <div className="container" style={{ paddingTop:0 }}>
        ...
        <div style={{ display:'flex',gap:10,flexWrap:'wrap',padding:'16px 0',borderBottom:'1px solid var(--border)' }}>
          ...
          {phone && <a href={`https://wa.me/91${phone.replace(/\D/g,'')}`} target="_blank" rel="noreferrer" className="btn btn-ghost btn-sm"><MessageCircle size={14} /> WhatsApp Preview</a>}
        </div>
        ...
        <div className="biz-detail-grid">
          ...
          <div style={{ display:'flex',flexDirection:'column',gap:14 }}>
            <SideCard title="Contact Info">
              {[phone&&{icon:Phone,label:'Phone',value:phone},biz.whatsappNo&&{icon:MessageCircle,label:'WhatsApp',value:biz.whatsappNo},biz.landline&&{icon:Phone,label:'Landline',value:biz.landline},biz.email&&{icon:Mail,label:'Email',value:biz.email},biz.website&&{icon:Globe,label:'Website',value:biz.website}].filter(Boolean).map((r,i)=><InfoRow key={i} {...r} />)}
            </SideCard>
